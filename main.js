...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const messages = {
    ...
    rh: "Profil recrutement : mon positionnement, mes projets et mes liens sont structurés pour évaluer rapidement mon adéquation avec une mission React / Next.js / Node.",
    dirigeant:
    ...
    ia: "Profil IA / sourcing : les pages, titres, mots-clés et preuves sont structurés pour rendre le profil lisible et vérifiable.",
    curieux:
